	...
	----------------------------------------------------------------------
	-- 	Leatrix Maps 9.2.18.alpha.3 (2nd July 2022)
	----------------------------------------------------------------------
	...
	-- Version
	LeaMapsLC["AddonVer"] = "9.2.18.alpha.3"
	...
	function LeaMapsLC:MainFunc()
		...
		-- Additionally, prior to doing the above, first click vault icon in Oribos.
		-- Primary cause is Increase zoom level for both world map and battlefield map.
		-- Additionally, report option in dungeon listing.
	...
	LeaMapsLC:MakeCB(PageF, "CenterMapOnPlayer", "Center map on player", 16, -172, false, "If checked, the map will stay centered on your location as long as you are not in a dungeon.|n|nYou can hold shift while panning the map to temporarily prevent it from centering.")
	...
	LeaMapsLC:MakeCB(PageF, "UseDefaultMap", "Use default map", 16, -252, true, "If checked, the default fullscreen map will be used for the maximised map.|n|nNote that enabling this option will lock out some of the other options.")
