	...
	----------------------------------------------------------------------
	-- 	Leatrix Maps 9.1.29.alpha.1 (12th December 2021)
	----------------------------------------------------------------------
	...
	-- Version
	LeaMapsLC["AddonVer"] = "9.1.29.alpha.1"
	...
	function LeaMapsLC:MainFunc()
		...
		if LeaMapsLC["ShowIcons"] == "On" then
			...
			if standingID and standingID >= 7 then
				PinData[111] = PinData[111] or {}; tinsert(PinData[111], {"PortalN", 74.7, 31.4, L["Caverns of Time"], L["Portal from Zephyr"]})
			end
			...
			if IsDungeonOnMapID(1527, 1180) then
				...
				PinData[1527] = PinData[1527] or {}; tinsert(PinData[1527], {"Raid", 55.1, 43.9, L["Ny'alotha, The Waking City"], L["Raid"], 1180})
			end

			if IsDungeonOnMapID(1530, 1180) then
				-- Show Ny'alotha on Vale of Eternal Blossoms map
				PinData[1530] = PinData[1530] or {}; tinsert(PinData[1530], {"Raid", 40.1, 45.5, L["Ny'alotha, The Waking City"], L["Raid"], 1180})
			end
